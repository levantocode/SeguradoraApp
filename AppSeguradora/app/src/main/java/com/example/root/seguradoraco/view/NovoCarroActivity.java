...
public class NovoCarroActivity extends AppCompatActivity {
    ...
    private List<String> listaNomeMarcas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaNomeMarcas = listaMarcas.getNomeTodasMarcas();
        ...
        //Spinner Marca
        adapterMarca = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, listaNomeMarcas);
        ...
        spnMarca.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                //Spinner Modelo
                adapterModelo.addAll(listaModelos.getNomeTodosModelos());
